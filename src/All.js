...
<div class="col-xs-6 col-sm-3 placeholder">
    ...
    <div class="container">
        <div>
            <RX.Button onPress={() => (this.onChangeGet5())} ><a style={{ color: "blue" }}><b>Click here to view Entire User Details :</b><br></br><br></br>{this.state.bulkdata} <span class="sr-only">(current)</span></a></RX.Button>
